...
import { EditCouponTypes } from './types';
...
const EditCoupon: React.FC<EditCouponTypes> = ({ dataItem, onClose, refreshFeth }) => {
        ...
        <S.Row>
          ...
          >
            ...
            <S.GroupedRadiosWrapper>
              ...
              <RadioGroupCustom
                arialabelledby="discount-label"
                defaultValue={inputValues.discount}
                name="discount"
              >
